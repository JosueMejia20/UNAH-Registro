class UnahSidebar extends HTMLElement {
    connectedCallback() {
        ...
        // Nuevos atributos configurables
        const sidebarTitle = this.getAttribute("sidebar-title") || "Portal Estudiantil";
        const userName = this.getAttribute("user-name") || "Estudiante UNAH";
        ...
        this.innerHTML = `
            <div class="sidebar d-flex flex-column flex-shrink-0">
                <div class="d-flex align-items-center mb-4 text-white text-decoration-none">
                    <span class="fs-5 ms-2">${sidebarTitle}</span>
                </div>
